...
var ProjectService = (function () {
    ...
    ProjectService.prototype.getPojects = function () {
        return this.http.get('/api/projects').map(function (response) {
    ...
    ProjectService.prototype.getProjectAsync = function (id) {
        return this.http.get('/api/projects' + id).map(function (response) {
            return response.json();
        }).catch(this.handleExpection);
    };
    ...
    ProjectService.prototype.saveProjectAsyn = function (project) {
        var headers = new http_1.Headers({ 'Content-Type:': 'application/json' });
        var requestOptions = new http_1.RequestOptions({ headers: headers });
        return this.http.post('/api/events', project, Option).map(function (response) {
            return response.json;
        }).catch(this.handleExpection);
    };
    ...
    ProjectService.prototype.searchSessionAysn = function (searchTerm) {
        return this.http.get('/api/sessions/search?search=' + searchTerm).map(function (response) {
            return response.json();
        }).catch(this.handleExpection);
    };
    ProjectService.prototype.handleExpection = function (error) {
